...
class CalculatorServiceImplTest {
    ...
    @Test
    void plus_num1PlusNum2_resultPositive() {
        int result = underTest.plus(4,4);
        assertEquals(8,result);
    }
    @Test
    void plus_num1PlusNum2_resultNegative() {
    ...
    @Test
    void minus_num1MinusNum2_resultNegative() {
    ...
    @Test
    void multiply_num1NegativeMultiplierNum2_resultNegative() {
        int result = underTest.multiply(5,-5);
        assertEquals(-25,result);
    }
